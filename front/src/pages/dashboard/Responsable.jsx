...
dayjs.locale('fr');
import { KPICard, StatCard, StatLabel, StatValue, StatsGrid, DashboardGrid,ChartContainer  } from '../../utils/dashboardStyle';
							...
							<ChartContainer>
								<ResponsiveContainer width="100%" height={280}>
									<BarChart data={mockResponsableData.managerRatio}>
										...
										/>
										<Bar dataKey="ratio" fill="url(#colorRatio)" radius={[8, 8, 0, 0]} />
									</BarChart>
								</ResponsiveContainer>
							</ChartContainer>
						</KPICard>
