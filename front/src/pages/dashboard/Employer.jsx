...
export const Employer = ({mockUserData}) => {
	return (
		<>
			<StatsGrid>
				<StatCard color="#4F46E5">
					<StatLabel>Présence</StatLabel>
					<StatValue>{(mockUserData.personalAttendance.reduce((acc, curr) => acc + curr.rate, 0) / mockUserData.personalAttendance.length).toFixed(1)}%</StatValue>
				</StatCard>
				<StatCard color="#10B981">
					<StatLabel>Conformité</StatLabel>
					<StatValue>{mockUserData.contractRate.rate}%</StatValue>
				</StatCard>
				<StatCard color="#F59E0B">
					<StatLabel>Pause Moy.</StatLabel>
					<StatValue>{mockUserData.pauseAverage.minutes}min</StatValue>
				</StatCard>
				<StatCard color="#8B5CF6">
					<StatLabel>Congés</StatLabel>
					<StatValue>{mockUserData.leaveDays.average}j</StatValue>
				</StatCard>
			</StatsGrid>
			...
			<DashboardGrid>
				<KPICard>
					...
					<ChartContainer>
						<ResponsiveContainer width="100%" height={280}>
							<AreaChart data={mockUserData.personalAttendance}>
								<defs>
				...
				<KPICard>
					...
					<ChartContainer>
						<ResponsiveContainer width="100%" height={280}>
							<BarChart data={mockUserData.monthlyHours}>
								<defs>
				...
				<WideKPICard>
					...
					<ChartContainer>
						<ResponsiveContainer width="100%" height={280}>
							<LineChart data={mockUserData.arrivalDeparture}>
								<CartesianGrid strokeDasharray="3 3" stroke="#E5E7EB" />
				...
				<KPICard>
					...
					<ChartContainer>
						<ResponsiveContainer width="100%" height={280}>
							<PieChart>
								<Pie
									data={mockUserData.warningsByType}
									cx="50%"
									cy="50%"
									labelLine={false}
									...
									dataKey="count"
								>
									{mockUserData.warningsByType.map((entry, index) => (
